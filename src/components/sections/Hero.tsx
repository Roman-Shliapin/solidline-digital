    ...
    return (
        <section id="hero" className="min-h-screen flex items-center justify-center text-center">
            <div className="max-w-2xl mx-auto px-6">
                ...
                <Link href="/get-started" className="inline-flex items-center gap-2 bg-[#7C5CFF] px-8 py-3 rounded-full font-semibold transition-all duration-300 hover:bg-[#6B4FE0] hover:-translate-y-0.5 shadow-lg shadow-[#7C5CFF]/20" style={{ opacity: 0, animation: "fade-up 0.8s ease-out 0.6s forwards" }}>start your project <HiOutlineArrowRight /></Link>
            </div>
        </section>
    )
};
