            ...
            <div className="max-w-5xl mx-auto px-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    {services.map(service => (
                        <div key={service.title} className="bg-gradient-to-br from-[#141414] to-[#0E0E0E] border border-[#222] p-8 rounded-2xl transition-all duration-300 hover:border-[#7C5CFF]/50 hover:shadow-lg hover:shadow-[#7C5CFF]/5">
